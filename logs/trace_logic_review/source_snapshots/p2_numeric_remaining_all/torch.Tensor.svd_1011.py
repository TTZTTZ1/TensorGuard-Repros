...
_input_tensor = torch.tensor(_input_tensor, dtype=torch.double)
_input_tensor = torch.tensor(_input_tensor, dtype=torch.uint8)
_input_tensor = torch.tensor(_input_tensor, dtype=torch.long).type(torch.FloatTensor)
