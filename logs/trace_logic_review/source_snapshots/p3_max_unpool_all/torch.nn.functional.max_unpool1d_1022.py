...
result = torch.trunc((result * 2))
result = torch.round((result * 2))
result = torch.trunc((result * 3))
result = torch.round((result * 3))
result = torch.trunc((result * 4))
result = torch.round((result * 4))
result = torch.trunc((result * 5))
result = torch.round((result * 5))
result = torch.floor(((result - result) + 1))
result = torch.sum(result, dim=1)
result = torch.sum(result, dim=0).detach()
result = torch.abs(result)
