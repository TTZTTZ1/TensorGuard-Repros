...
stride = kernel_size
padding = 0
result = torch.nn.functional.max_unpool3d(input, indices, kernel_size, stride, padding, output_size=None)
result = result.view(4, 2, 2, (- 1))
torch.as_tensor(result, dtype=torch.float32)
