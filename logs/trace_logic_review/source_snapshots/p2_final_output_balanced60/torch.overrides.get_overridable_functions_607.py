torch.autograd.Function = torch.overrides.custom_type_deserializer
torch.autograd.Function = torch.overrides.custom_type_serializer
torch.overrides.type_overrides_map = {'torch.Tensor': 'torch.Tensor'}
